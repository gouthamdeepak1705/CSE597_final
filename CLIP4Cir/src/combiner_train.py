...
if __name__ == '__main__':
    ...
    parser.add_argument("--loss-alpha", default=0.7, type=float, help="Alpha Loss")                   
    parser.add_argument("--save-best", dest="save_best", action='store_true',
                        help="Save only the best model during training")
    parser.add_argument("--combiner-path", type=str, help="Path to the pretrained Combiner model")
